...
pub type EntryFunction = extern fn(memory_size: u64,
                                   write: extern fn(u8) -> ())
                                   -> u64;

extern fn rts_write(c: u8) {
    print!("{}", c as char);
}
...
//        ee.with_function(main_function, |main: extern fn((u64, usize)) -> u64| {
////            main((30_000, rts_write));
//        });
//    }
